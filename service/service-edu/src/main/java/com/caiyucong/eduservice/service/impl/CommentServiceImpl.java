...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    @Override
    public R pageQuery(Long current, Long limit, CommentQuery commentQuery) {

        Page<CommentInfoVo> page = new Page<>(current, limit);

        baseMapper.getCommentPageList(page,commentQuery);

        return R.ok().putData("rows", page.getRecords())
